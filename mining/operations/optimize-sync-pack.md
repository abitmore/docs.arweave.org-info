---
description: Tips for optimizing the sync and pack process
---
...
4. RAM _(more heavily used in mining than in syncing/packing, but can become a bottleneck under certain situations)_
...
Packing and unpacking can be parallelized across chunks, so you can add more cores or increase the clock speed to increase your packing speed. See the [Benchmarking](benchmarking.md) guide for guidance on evaluating CPU pack speed.
